...
RelativeOffsetConf::RelativeOffsetConf(veins::Coord* ConfPosMax, veins::Coord* ConfSpeedMax,
...
veins::Coord RelativeOffsetConf::OffsetPosConf(veins::Coord curPosConf) {
    ...
    return veins::Coord(curPosConf.x + deltaConfPosR, curPosConf.y + deltaConfPosR, 0);
}

veins::Coord RelativeOffsetConf::OffsetSpeedConf(veins::Coord curSpeedConf) {
    MDMLib mdmLib = MDMLib();
    GeneralLib genLib = GeneralLib();
    ...
    return veins::Coord(curSpeedConf.x + deltaConfSpeedR, curSpeedConf.y + deltaConfSpeedR, 0);
}

veins::Coord RelativeOffsetConf::OffsetAccelConf(veins::Coord curAccelConf) {
    MDMLib mdmLib = MDMLib();
    GeneralLib genLib = GeneralLib();
    ...
    return veins::Coord(curAccelConf.x + deltaConfAccelR, curAccelConf.y + deltaConfAccelR, 0);
}

veins::Coord RelativeOffsetConf::OffsetHeadingConf(veins::Coord curHeadingConf) {
    MDMLib mdmLib = MDMLib();
    GeneralLib genLib = GeneralLib();
    ...
    return veins::Coord(curHeadingConf.x + deltaConfHeadingR, curHeadingConf.y + deltaConfHeadingR, 0);
}
